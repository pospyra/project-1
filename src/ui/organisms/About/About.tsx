...
export const About = ({ className }: AboutProps) => {
  return (
    <div className="relative lg:px-20 md:px-[39px] lg:mb-[100px] sm:px-[39px] px-[15px] md:mb-[80px]">
      <div>
        <h2 className="text-xl mb-[36px] sm:text-4xl sm:mb-[80px] ">
          About me
        </h2>
          ...
          <div>
            <div className="grid gap-4 max-w-[290px] mb-16 lg:max-w-[537px] md:max-w-[380px]">
              ...
              <p className="body-text text-sm sm:text-xl text-greydark">
                <span className="subtitle text-black">Nick Richardson</span> -
        ...
        <div
          className={`${styles.information} grid gap-[48px] items-start lg:flex lg:gap-[217px] sm:gap-[80px] `}
        >
