  ...
  return (
    <div>
      <header className="flex justify-between h-16 px-3.5 lg:px-85px md:px-[39px] sm:px-3.5">
        ...
        <nav className="hidden sm:flex items-end items-center justify-end gap-6">
          <a href="/" className={`${styles.link} subtitle-2`}>
            Main
          </a>
          <a href="/about" className={`${styles.link} subtitle-2`}>
            About
          </a>
          <a href="/get" className={`${styles.link} subtitle-2`}>
            Get in touch{' '}
          </a>
        </nav>
