...
export const MainBlock = () => {
  return (
    <div className={`${styles['block-wrap']} responsive flex pl-3.5 lg:pl-20 md:pl-10 sm:pl-10 pl-[15px]`}>
      ...
      <div className={`${styles['background-wrap']} relative w-full lg:w-[1070px] lg:h-[864px] sm:w-[681px] sm:h-[540px] h-[345px] w-[537px] `}>
